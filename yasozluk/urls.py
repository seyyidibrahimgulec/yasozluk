...
urlpatterns = [
    ...
    path("user_profile/entries/<int:user_pk>", UserProfileEntryView.as_view(), name="user_entries"),
    path("user_profile/votes/<int:user_pk>", UserProfileVoteView.as_view(), name="user_votes"),
    path("user_profile/favorites/<int:user_pk>", UserProfileFavoriteView.as_view(), name="user_favorites"),
